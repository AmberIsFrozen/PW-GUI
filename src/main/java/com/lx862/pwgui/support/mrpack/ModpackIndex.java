...
public class ModpackIndex {
    ...
    public static String DEP_MINECRAFT = "minecraft";
    public static String DEP_FORGE = "forge";
    public static String DEP_NEOFORGE = "neoforge";
    public static String DEP_FABRIC = "fabric-loader";
    public static String DEP_QUILT = "quilt-loader";
