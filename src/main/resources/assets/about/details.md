...
**[RSyntaxTextArea](https://github.com/bobbylight/RSyntaxTextArea)** - Syntax highlighting for "Plain Text" tab.  
...
**[Launch4j](https://launch4j.sourceforge.net/) & [gradle-launch4j](https://github.com/TheBoegl/gradle-launch4j)** - Create Windows **.exe** wrapper.